...
signAcademicHonestyPolicy('Nathan Bendich', 'nxb2101');
...
data = load('light_dirs'); light_dirs_5x3 = data.light_dirs_5x3;    %   The lighting directions for the vases are the same as they were for the spheres
vase_img_cell = cell(5, 1);
for i = 1:5
    vase_img_cell{i} = imread(['vase' num2str(i) '.png']); 
end
